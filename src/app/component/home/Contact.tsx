          ...
          <div className="space-y-6">
            <Card className="border-0 shadow-card">
              <CardContent className="p-6">
                ...
                <a href="tel:+1234567890" className="text-primary font-bold text-xl hover:text-primary-glow transition-colors">
                  (123) 456-7890
                </a>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-card">
              <CardContent className="p-6">
                ...
                <a href="mailto:info@probuildconstruction.com" className="text-primary font-medium hover:text-primary-glow transition-colors">
                  info@probuildconstruction.com
                </a>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">30+ mile radius</p>
                  </div>
                </div>
